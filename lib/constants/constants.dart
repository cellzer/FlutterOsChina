...
abstract class AppInfos {
  static const String CLIENT_ID = 'xzBKBDNhRX4AxIcGNc2l';//应用id
  static const String CLIENT_SECRET = 'uG6HTU3nnB8eSzVxdJXjCGsEfUL2tnuu';//应用密钥
  static const String REDIRECT_URI = 'www.baidu.com';//回调地址
}
